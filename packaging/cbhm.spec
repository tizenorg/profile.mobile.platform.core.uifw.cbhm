...
ln -s ../%{name}.service %{buildroot}/usr/lib/systemd/user/default.target.wants/%{name}.service
...
%{_libdir}/systemd/user/default.target.wants/%{name}.service
%{_libdir}/systemd/user/%{name}.path
%{_libdir}/systemd/user/default.target.wants/%{name}.path

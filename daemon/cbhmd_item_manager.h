...
#ifdef HAVE_X11
Cbhmd_Cnp_Item *item_add_by_data(Cbhmd_App_Data *ad, Ecore_X_Atom type, void *data, int len, Eina_Bool show_msg);
#else
...
void item_delete_by_Cbhmd_Cnp_Item(Cbhmd_App_Data *ad,
                                   Cbhmd_Cnp_Item *item);

...
static Eina_Bool storage_item_write(Cbhmd_App_Data *ad,
                                    Cbhmd_Cnp_Item *item);
static Eina_Bool storage_item_delete(Cbhmd_App_Data *ad,
                                     Cbhmd_Cnp_Item *item);
static Eina_Bool storage_item_update(Cbhmd_App_Data *ad,
                                     Cbhmd_Cnp_Item *item);

...
static void _cbhmd_on_name_request(void *data, const Eldbus_Message *msg,
...
static Eldbus_Message* _cbhmd_eldbus_show(const Eldbus_Service_Interface *iface,
...
static Eldbus_Message* _cbhmd_eldbus_hide(const Eldbus_Service_Interface *iface,
                                          const Eldbus_Message *msg)
{
   FN_CALL();
   Cbhmd_App_Data *ad;
...
static Eldbus_Message* _cbhmd_eldbus_count(
...
int cbhmd_eldbus_init(Cbhmd_App_Data *ad)
{
   FN_CALL();

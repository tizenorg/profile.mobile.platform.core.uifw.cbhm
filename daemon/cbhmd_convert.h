...
char* cbhmd_convert_get_entry_string(cbhmd_app_data_s *ad, int type_index, const char *str);
char* cbhmd_convert_get_image_path_string(cbhmd_app_data_s *ad, int type_index, const char *str);

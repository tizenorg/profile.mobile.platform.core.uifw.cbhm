...
static void _drawer_gengrid_select_cb(void *data, Evas_Object *obj,
                                       void *event)
{
     ...
     if (item->gitem_style == GRID_ITEM_STYLE_IMAGE)
       item->gitem = elm_gengrid_item_prepend(dd->gengrid, &dd->gic_image,
                                              item, _drawer_gengrid_select_cb, item);
                                                 ...
                                                 &dd->gic_combined, item, _drawer_gengrid_select_cb, item);
...
static Evas_Object *_drawer_grid_image_content_get(void *data,

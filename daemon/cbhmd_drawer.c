...
static Evas_Event_Flags _drawer_flick_end_cb(void *data, void *event_info)
{
...
static void _drawer_gengrid_select_cb(void *data, Evas_Object *obj, void *event)
{
...
static Eina_Bool _drawer_keydown_cb(void *data, int type, void *event)
{
...
static void _drawer_title_close_btn_access_activate_cb(void *data,
...
static void _drawer_title_delete_btn_access_activate_cb(void *data,
                                                        Evas_Object *obj, Elm_Object_Item *item)
{
   Cbhmd_App_Data *ad = (Cbhmd_App_Data *)data;
   if (!ad) return;
...
static void _drawer_title_delete_all_btn_access_activate_cb(void *data,
                                                            Evas_Object *obj, Elm_Object_Item *item)
{
   FN_CALL();
   int ret;
...
static Eina_Bool _drawer_item_add(Cbhmd_App_Data *ad, Cbhmd_Cnp_Item *item)
{
...
static Eina_Bool _drawer_item_del(Cbhmd_App_Data *ad, Cbhmd_Cnp_Item *item)
{
   if (item->gitem)
     {
...
static char *_drawer_grid_text_get(void *data, Evas_Object *obj,
                                   const char *part)
{
   FN_CALL();
   Cbhmd_Cnp_Item *item = data;
...
static Evas_Object *_drawer_grid_content_get(void *data, Evas_Object *obj,
                                             const char *part)
{
   Cbhmd_Cnp_Item *item = data;
...
static Evas_Object *_drawer_grid_image_content_get(void *data, Evas_Object *obj,
                                                   const char *part)
{
   Cbhmd_Cnp_Item *item = data;
   Cbhmd_App_Data *ad;
...
static Evas_Object *_drawer_grid_combined_content_get(void *data,
...
static void _drawer_grid_realized_cb(void *data, Evas_Object *obj,
                                     void *event_info)
{
...
static void _drawer_ok_btn_clicked_cb(void *data, Evas_Object *obj,
                                      void *event_info)
{
   Cbhmd_App_Data *ad = data;
   Cbhmd_Drawer_Data *dd = ad->drawer;
   ...
   while (gitem)
     {
        ...
        if (!gitem_data->locked) item_delete_by_Cbhmd_Cnp_Item(ad, gitem_data);
     }
...
static void _drawer_cancel_btn_clicked_cb(void *data, Evas_Object *obj,
                                          void *event_info)
{
   Cbhmd_App_Data *ad = data;
   Cbhmd_Drawer_Data *dd = ad->drawer;
...
static void _drawer_layout_clicked_cb(void *data, Evas_Object *obj,
...
void _drawer_wm_rotation_changed_cb(void *data, Evas_Object * obj, void *event)
{
   if (!data) return;
...
Cbhmd_Drawer_Data* cbhmd_drawer_init(Cbhmd_App_Data *ad)
{
   ...
   ad->draw_item_add = _drawer_item_add;
   ad->draw_item_del = _drawer_item_del;

             ...
             if (filepath)
               {
                  if (ecore_file_exists(filepath))
                    {
                       cbhmd_item_add_by_data(ad, ad->targetAtoms[ATOM_INDEX_IMAGE].atom[0],
             ...
             if (filepath && ecore_file_exists(filepath))
               {
                  ...
                  cbhmd_item_add_by_data(ad, ad->targetAtoms[ATOM_INDEX_IMAGE].atom[0], filepath, SAFE_STRLEN(filepath) + 1, EINA_FALSE);
               }
             else FREE(filepath);
          }
     }

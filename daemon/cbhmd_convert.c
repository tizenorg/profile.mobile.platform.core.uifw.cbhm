                                          ...
                                          const char *str)
{
   ...
   if (type_index == ATOM_INDEX_HTML)
     ...
     if (type_index == ATOM_INDEX_EFL)
       image_path = _convert_efl_to_image_path(ad, type_index, str);
...
void cbhmd_convert_target_atoms_init(Cbhmd_App_Data *ad)
{
   ...
   text_converter_func converts_to_entry[ATOM_INDEX_MAX] = {NULL,
        _convert_text_to_entry_cb, _convert_html_to_entry_cb,
        _convert_efl_to_entry_cb, _convert_image_path_to_entry_cb,
        _convert_polaris_to_entry_cb};

   text_converter_func converts[ATOM_INDEX_MAX][ATOM_INDEX_MAX] = { {NULL, NULL,
        NULL, NULL, NULL, NULL}, {NULL, _convert_do_not_convert,
             _convert_text_to_html, _convert_text_to_efl, NULL, NULL}, {NULL,
                  _convert_to_text, _convert_do_not_convert, _convert_html_to_efl,
                  _convert_html_to_image_path, NULL}, {NULL, _convert_to_text,
                       _convert_efl_to_html, _convert_do_not_convert,
                       _convert_do_not_convert, NULL}, {NULL, NULL,
                            _convert_image_path_to_html, _convert_image_path_to_efl,
                            _convert_image_path_to_image_path, NULL}, {NULL, _convert_to_text,
                                 NULL, NULL, NULL, _convert_do_not_convert}};
